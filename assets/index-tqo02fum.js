...
`,
  ...
  S = [
    [
      ...
      `Neutralize carbon emissions by investing in certified carbon offset projects that support a healthier planet.`,
      `/media/001.jpg`,
    ],
    [
      `02`,
      `Measure Your Impact`,
      `Assess your carbon footprint, understand your emissions and identify practical areas for improvement.`,
      `/media/002.jpg`,
    ],
    [
      `03`,
      `Optimize Your Carbon Portfolio`,
      `Navigate the carbon credit market to manage emissions and support meaningful environmental projects.`,
      `/media/003.jpg`,
    ],
    [
      `04`,
      `Sustainable Business Strategy`,
      `Build a sustainability strategy with achievable environmental goals tailored to your business.`,
      `/media/005.jpg`,
    ],
  ],
  H = [
    {
      ...
      accent: `Energizing Tomorrow.`,
      text: `We turn environmental ambition into measurable progress through practical climate and clean-energy solutions.`,
      image: `/media/Default_lush_green_forest_with_a_winding_river_flowing_through_2.jpg`,
      alt: `A river flowing through a protected green forest`,
      cta: `Explore our solutions`,
      href: `/our-services`,
    },
    {
      eyebrow: `Our commitment`,
      title: `Progress for business,`,
      accent: `positive impact for nature.`,
      text: `We help organisations move from climate goals to credible action—creating enduring value for people, business and the planet.`,
      image: `/media/Default_rain_forest_carbon_exchange_1.jpg`,
      alt: `Tropical rainforest representing climate action`,
    ...
    (0, x.jsxs)(`header`, {
      ...
      children: [
        (0, x.jsx)(`a`, {
          className: `brand`,
          href: `/`,
          "aria-label": `Standard Energy Asia home`,
...
function te() {
  return (0, x.jsxs)(`footer`, {
    children: [
      ...
      (0, x.jsxs)(`div`, {
        children: [
          (0, x.jsx)(`h3`, { children: `Contact Us` }),
          (0, x.jsxs)(`p`, {
            children: [
              `Main Branch`,
              (0, x.jsx)(`br`, {}),
              `D1-6-1,2,3 & 3A Solaris Dutamas, Publika Jalan Dutamas 1, 50480 Kuala Lumpur, Malaysia`,
            ],
          }),
          (0, x.jsxs)(`p`, {
            children: [
              `Kelantan Branch`,
              (0, x.jsx)(`br`, {}),
              `Suite 1.03-23, Wisma ZARA, Business Centre, 16150 Kubang Kerian, Kelantan, Malaysia`,
            ],
          }),
          (0, x.jsx)(`a`, {
      ...
      (0, x.jsx)(`small`, { children: `© 2026 Standard Energy Asia Sdn Bhd` }),
    ],
  });
}
function ne({ eyebrow: e, title: t, text: n }) {
  return (0, x.jsxs)(`section`, {
    className: `page-hero`,
    children: [
      (0, x.jsx)(`span`, { children: e }),
      (0, x.jsx)(`h1`, { children: t }),
          ...
          children: [
            H.map((t, n) =>
              (0, x.jsx)(
                `img`,
                {
                  className: n === e ? `hero-image active` : `hero-image`,
                  src: t.image,
                  alt: t.alt,
                },
                t.image,
            ...
            (0, x.jsx)(`div`, { className: `hero-shade` }),
            H.map((t, n) =>
              (0, x.jsxs)(
                `div`,
                {
                  className: n === e ? `hero-copy active` : `hero-copy`,
                  children: [
                    (0, x.jsx)(`span`, { children: t.eyebrow }),
                    (0, x.jsxs)(`h1`, {
                      children: [
                        t.title,
                        (0, x.jsx)(`br`, {}),
                        (0, x.jsx)(`em`, { children: t.accent }),
                      ],
                    }),
                    (0, x.jsx)(`p`, { children: t.text }),
                    (0, x.jsx)(`a`, {
                      className: `button`,
                      href: t.href,
                      children: t.cta,
        ...
        children:
          {
            home: (0, x.jsx)(re, {}),
            "about-us": (0, x.jsx)(w, {}),
            "our-services": (0, x.jsx)(ie, {}),
            awards: (0, x.jsx)(ae, {}),
            news: (0, x.jsx)(oe, {}),
            sponsorship: (0, x.jsx)(se, {}),
            "contact-us": (0, x.jsx)(ce, {}),
          }[e] ??
          (0, x.jsx)(ne, {
            eyebrow: `404`,
            title: `Page not found.`,
            text: `The page you requested is unavailable.`,
          }),
      }),
      (0, x.jsx)(te, {}),
    ],
...
var ue = window.location.pathname.replace(/^\/+|\/+$/g, ``) || `home`;
(0, y.createRoot)(document.getElementById(`root`)).render(
  (0, x.jsx)(b.StrictMode, { children: (0, x.jsx)(le, { slug: ue }) }),
);
